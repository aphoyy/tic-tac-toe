...
const userIcon = '<img src="./img/user.png" width="100px" height="100px"/>'; // user icon (default size 100x100)
const cpuIcon = '<img src="./img/computer.png" width="100px" height="100px"/>'; // cpu  icon (default size 100x100)
